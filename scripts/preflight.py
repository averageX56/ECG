...
parser.add_argument('--profile',choices=['smoke','bert','founder','delineation'],default='smoke')
...
required={'smoke':['artifacts/beat_features_qt/manifest.json','LUDB/1.hea','artifacts/delineator_qt.pt'],
          ...
          'delineation':['LUDB','data/qtdb_external','artifacts/catalog.csv']}[args.profile]
...
if args.profile in ['bert','founder'] and vram<35:missing.append('GPU with >=35 GiB VRAM for the configured A100 profile')
